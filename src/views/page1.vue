      ...
      <div class="page">
        <div class="article-tittle">
          ...
          <div class="page-content">
            <img src="https://img2.baidu.com/it/u=2385452176,3317193029&fm=26&fmt=auto&gp=0.jpg" alt="" />
            <br />
            <p>
              剪纸是一门非常古老的手艺，广泛存在于民间各地。或许也正是由于这种广泛性和百姓化，自古其艺术价值就没有受到太多重视，几无典籍有所记载，直到近些年来这门手艺被列入非遗，才有一些专著出现，一些大师的作品得以形成体系呈现在人们面前。王计汝1948年生于山西省中阳县一户贫苦农家，自幼从母亲处学得剪纸手艺，凭借几十年磨砺的精湛手艺，成为首批国家级非遗传承人
            </p>
            <p>
...
<style scoped>
body {
  /* background: linear-gradient(30deg,#feac5e,#c779d0,#4bc0c8); */
...
.wrap .w-middle .currentPosition a {
}
...
.wrap .w-middle .page .article-tittle > p:first-of-type {
  font-size: 30px;
  font-weight: bolder;
}
.article-tittle{
...
.wrap .w-middle .page .page-content {
  border-top: 1px solid rgb(153, 166, 196);
  padding-top: 25px;
}

.wrap .w-middle .page .page-content p {
  letter-spacing: 2px;
  line-height: 2em;
  font-size: 15px;
  text-indent: 2em;
...
.top {
  margin: auto;
  width: 1345px;
  /* background-color: linear-gradient(to bottom,rgb(),white); */
}
